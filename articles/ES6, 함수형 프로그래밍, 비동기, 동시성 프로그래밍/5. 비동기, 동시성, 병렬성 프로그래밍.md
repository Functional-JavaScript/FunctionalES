...
`findC, someC, everyC, noneC`는 `find, some, evey, none`와 거의 같지만, 모두 동시에 출발 시킨 후 먼저 온 결과들 중에 원하는 결과를 얻으면 나머지 결과는 기다리지 않고 끝냅니다.
...
`find, some, evey, none`과 `findC, someC, everyC, noneC`는 상황에 따라 다르게 필요합니다.
